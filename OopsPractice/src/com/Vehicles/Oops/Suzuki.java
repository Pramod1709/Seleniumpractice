...
public class Suzuki extends Car{
	...
	public Suzuki(String carType, String carModel, String modelNo, long chasisNo, int price, String driveType,
	...
	public String toString() {
		return "Suzuki [Car Type : " + carType + ", Car Model : " + carModel + ", Model No : " + modelNo + ", Chasis No : "
